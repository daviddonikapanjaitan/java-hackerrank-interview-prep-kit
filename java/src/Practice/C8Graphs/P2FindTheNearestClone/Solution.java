package Practice.C8Graphs.P2FindTheNearestClone;
...
public class Solution {
    ...
    static int findShortest(int graphNodes, int[] graphFrom, int[] graphTo, long[] ids, int val) {
        ...
        Map<Integer, List<Integer>> dependencyList = new LinkedHashMap<>();
        ...
        for (Integer integer : colorList) {
            bfs(integer, val, ids, dependencyList);
        }

        return low;
    }

    static final void bfs(int start, int color, long[] ids, Map<Integer, List<Integer>> dependencyList) {
        ...
        while (!queue.isEmpty()){
            ...
            List<Integer> li = dependencyList.get(key);
