package others.C1LinkedLists.P4ReverseCircularSinglyLinkedLists;
...
class CircularSinglyLinkedList {
    ...
    public Node reverse (Node headInput){
        if(headInput == null){
            head = null;
            return null;
        }
